...
public class Room15Vampire extends Room15User {
	...
	public void promoteToComplainVampire(Room15Vampire vampire) {
		/* compiled code */
	}

	public void fileComplains(String[] complains) {
		/* compiled code */
	}
	
	// lasts 12 hours, cooldown 12 hours
	public void setHumanForm(Room15Vampire vampire) {
		/* compiledcode */
	}
}
